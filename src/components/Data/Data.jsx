...
export const data = [
        {
          ...
          precio: 1500,
          video: <iframe width="80%" height="300px" src="https://www.youtube.com/embed/rnTwm-n6sB0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        },
        {
          id:2, 
          ...
          precio: 1000,
          video: <iframe width="80%" height="300px" src="https://www.youtube.com/embed/WuHkcWCnwzg?list=PLyT5NcCVqdX_ygsTrXJEzFuiHLv_7wYxk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        },
        {
          id:3, 
          ...
          precio: 3000,
          video: <iframe width="80%" height="300px" src="https://www.youtube.com/embed/T4vVDyytrl4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        }
